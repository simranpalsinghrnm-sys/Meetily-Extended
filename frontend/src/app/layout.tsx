...
import { CommandPalette } from '@/components/ProjectSpaces/CommandPalette'
...
export default function RootLayout({
  ...
  const handleCalendarRecord = useCallback(async (event: CalendarEvent) => {
    console.log('[Layout] Calendar opt-in record', event.id, event.title);
    window.dispatchEvent(new CustomEvent('meetily:record-from-calendar', { detail: event }));
  }, []);
                      ...
                      <SidebarProvider>
                        <TooltipProvider>
                          <RecordingPostProcessingProvider>
                            <ProjectsProvider>
                            <CalendarProvider onPromptRecord={handleCalendarRecord}>
