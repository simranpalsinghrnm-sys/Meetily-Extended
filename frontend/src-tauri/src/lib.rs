...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        // Updater plugin disabled: no signing key configured for v1.
        ...
        .setup(|_app| {
            ...
            // Meetily Extended: start the ToolMySelf bridge HTTP server (loopback only)
            let bridge_app = _app.handle().clone();
            tauri::async_runtime::spawn(async move {
                if let Err(e) = bridge::commands::ensure_bridge_started(&bridge_app).await {
                    log::warn!("[bridge] failed to start: {}", e);
                }
            });
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // Meetily Extended: Company/Project tagging
            projects::commands::list_companies,
            projects::commands::upsert_company,
            projects::commands::list_projects,
            projects::commands::upsert_project,
            projects::commands::set_meeting_tag,
            projects::commands::get_meeting_tag,
            projects::commands::list_tagging_rules,
            projects::commands::create_tagging_rule,
            projects::commands::delete_tagging_rule,
            projects::commands::list_project_members,
            projects::commands::add_project_member,
